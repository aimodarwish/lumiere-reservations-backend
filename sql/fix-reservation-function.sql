-- =====================================================
-- FIX FOR create_lumiere_reservation FUNCTION
-- Run this in Supabase SQL Editor once to fix search_path / random bytes
-- =====================================================
...
begin
  ...
  loop
    ...
    -- Uses standard md5 + random which works universally without external extension dependency
    v_confirmation_code := 'LUM-' || upper(substr(md5(random()::text || clock_timestamp()::text), 1, 6));
